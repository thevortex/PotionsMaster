...
public class PlatinumPotionRecipe extends BrewingRecipe {


    public PlatinumPotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModRegistry.CALCINATEDPLATINUM_POWDER.get());
    }
