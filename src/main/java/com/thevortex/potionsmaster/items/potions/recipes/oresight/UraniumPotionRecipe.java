...
public class UraniumPotionRecipe extends BrewingRecipe {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModRegistry.CALCINATEDURANIUM_POWDER.get());
    }
    ...
    public ItemStack getOutput() {
        return PotionUtils.setPotion(new ItemStack(Items.POTION), ModPotions.URANIUM_SIGHT);
