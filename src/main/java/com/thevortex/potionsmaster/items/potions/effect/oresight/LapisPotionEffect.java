...
public class LapisPotionEffect extends MobEffect {

    public LapisPotionEffect(MobEffectCategory typeIn, int liquidColorIn) {
    ...
    public void applyEffectTick(LivingEntity entityLivingBaseIn, int amplifier) {
        ...
        if (entityLivingBaseIn instanceof AbstractClientPlayer) {
            ...
            if ((LAPIS.isDrawing() != true) && (!(entityLivingBaseIn.getEffect(ModPotionEffects.LAPISSIGHT) == null))) {
