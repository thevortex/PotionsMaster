...
public class NetheritePotionRecipe extends BrewingRecipe {
    ...
    public NetheritePotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModRegistry.CALCINATEDNETHERITE_POWDER.get());
    }
