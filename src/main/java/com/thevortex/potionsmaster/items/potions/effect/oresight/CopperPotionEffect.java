...
public class CopperPotionEffect extends Effect {

    public CopperPotionEffect(EffectType typeIn, int liquidColorIn) {
    ...
    public void performEffect(LivingEntity entityLivingBaseIn, int amplifier) {
        ...
        if (entityLivingBaseIn instanceof ClientPlayerEntity) {
            BlockDataWithUUID bdUUID = store.getStoreByReference(Ores.COPPER.toString());
            BlockData COPPER = bdUUID.getBlockData();
            if ((COPPER.isDrawing() != true) && (!(entityLivingBaseIn.getActivePotionEffect(ModPotionEffects.COPPERSIGHT) == null))) {
                COPPER.setDrawing(true);
            }
