...
public class OsmiumPotionRecipe extends BrewingRecipe {
    ...
    public OsmiumPotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModRegistry.CALCINATEDOSMIUM_POWDER.get());
    }
