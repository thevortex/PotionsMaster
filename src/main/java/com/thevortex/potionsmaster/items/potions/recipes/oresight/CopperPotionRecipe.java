...
public class CopperPotionRecipe extends BrewingRecipe {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModItems.CALCINATEDCOPPER_POWDER);
    }
    ...
    public ItemStack getOutput() {
        return PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.COPPER_SIGHT);
