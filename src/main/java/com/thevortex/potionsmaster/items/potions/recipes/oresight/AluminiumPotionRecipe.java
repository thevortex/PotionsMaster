...
public class AluminiumPotionRecipe extends BrewingRecipe {

    public AluminiumPotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public ItemStack getOutput() {
        return PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.ALUMINIUM_SIGHT);
