...
public class VibraniumPotionRecipe extends BrewingRecipe {


    public VibraniumPotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public ItemStack getOutput() {
        return PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.VIBRANIUM_SIGHT);
