...
public class GoldPotionRecipe extends BrewingRecipe {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModItems.CALCINATEDGOLD_POWDER);
    }
    ...
    public ItemStack getOutput() {
        return PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.GOLD_SIGHT);
    }
