...
public class QuartzPotionRecipe extends BrewingRecipe {


    public QuartzPotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModRegistry.CALCINATEDQUARTZ_POWDER.get());
    }
