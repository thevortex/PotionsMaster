...
public class CrimsonIronPotionRecipe extends BrewingRecipe {
    ...
    public CrimsonIronPotionRecipe(Ingredient input, Ingredient ingredient, ItemStack output) {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModItems.CALCINATEDCRIMSONIRON_POWDER);
    }
    ...
    public ItemStack getOutput() {
        return PotionUtils.addPotionToItemStack(new ItemStack(Items.POTION), ModPotions.CRIMSONIRON_SIGHT);
