...
public class CrimsonIronPotionRecipe extends BrewingRecipe {
    ...
    public boolean isIngredient(ItemStack ingredient) {
        return (ingredient.getItem().asItem() == ModRegistry.CALCINATEDCRIMSONIRON_POWDER.get());
    }
    ...
    public ItemStack getOutput() {
        return PotionUtils.setPotion(new ItemStack(Items.POTION), ModPotions.CRIMSONIRON_SIGHT);
