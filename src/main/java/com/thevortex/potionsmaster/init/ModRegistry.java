...
import com.thevortex.potionsmaster.items.powders.calcinated.CalcinatedPowder;
...
public class ModRegistry {
    ...
    public static final RegistryObject<Item> ITEM_MORTAR = ITEMS.register("tile_mortar",() -> new BlockItem(MORTAR.get(), new Item.Properties().tab(PotionsMaster.GROUP)));
